...
class GripperDataAugmentation:
    ...
    img_filename_pattern = 'pcd{}m.png'
    img_rc_pos_filename_pattern = 'pcd{}mcpos.png'
    img_rc_neg_filename_pattern = 'pcd{}mcneg.png'
    depth_img_filename_pattern = 'pcd{}m_d.png'
    depth_output_img_filename_pattern = 'pcd{}m_d.png'
    rc_pos_filename_pattern = 'pcd{}mcpos.txt'
    rc_neg_filename_pattern = 'pcd{}mcneg.txt'
    ...
    def __init__(self, file_path, img_num, output_file_path):
        ...
        self.depth_img_filename = os.path.join(file_path, self.depth_img_filename_pattern.format(img_num))
...
def main():
    ...
    for folder_num in range(0, 11):
        ...
        file_path = './/mirrored'
        output_file_path = './/augmentedMirroredDataSet//' + folder_num_str
        # file_path = 'D:\Gali\CS231N_Project\CornellDataset\mirrored\\' + folder_num_str
        # output_file_path = 'D:\Gali\CS231N_Project\CornellDataset\\augmentedMirroredDataSet\\' + folder_num_str
        for img_num in range(0, num_of_images_per_folder):
            ...
            for i in range(0, num_of_images_per_image):
                ...
                # myobject.draw_gripper_rect(output_file_path, output_file_path)
